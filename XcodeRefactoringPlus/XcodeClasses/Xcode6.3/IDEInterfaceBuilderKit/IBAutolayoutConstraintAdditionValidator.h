...
+ (id)nearestNeighborConstraintsForItems:(id)arg1 attribute:(unsigned long long)arg2 marginRelativeToContainer:(BOOL)arg3 useExistingConstant:(BOOL)arg4 selectedContainerItem:(id)arg5 context:(unsigned long long)arg6 document:(id)arg7;
+ (BOOL)canAddNearestNeighborConstraintForItems:(id)arg1 attribute:(unsigned long long)arg2 marginRelativeToContainer:(BOOL)arg3 selectedContainerItem:(id)arg4 context:(unsigned long long)arg5 document:(id)arg6;
+ (id)_nearestNeighborForItem:(id)arg1 attribute:(unsigned long long)arg2 marginRelativeToContainer:(BOOL)arg3 returningIsContainer:(char *)arg4 selectedContainerItem:(id)arg5 document:(id)arg6;
