...
- (const RenderCommandEncoder_1e21ccb5 *)renderCommandEncoderObjectFromID:(unsigned long long)arg1;
...
- (void)_updateResourceMapWithBoundFramebufferTextures:(unordered_map_75cc7d9b *)arg1 device:(const Device_4a5f6283 *)arg2 renderCommandEncoder:(const RenderCommandEncoder_1e21ccb5 *)arg3;
...
- (void)_addObjectToParent:(id)arg1 objectID:(unsigned long long)arg2 resourceType:(unsigned int)arg3 bindingType:(unsigned int)arg4 bindingIndex:(unsigned int)arg5 prefix:(const char *)arg6;
